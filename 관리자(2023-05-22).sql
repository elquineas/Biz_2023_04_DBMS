...
-- DROP : 물리적인 데이터 요소를 제거하기, 데이터 구조 제거, 많은 제이터를 한꺼번에 제거
--        데이터 파괴자 명려으 매우 신중하게 주의하면서 사용해야 한다
